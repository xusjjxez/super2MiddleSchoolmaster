...
class OverheadInfo(object):
    ...
    def create_load_screen_labels(self):
        ...
        self.create_label(world_label, 'WORLD', 450, 400)
        self.create_label(number_label, '1-1', 630, 400)
    ...
    def create_coin_counter(self):
        ...
        self.create_label(self.coin_count_images, '*00', 375, 135)


    def create_flashing_coin(self):
        """Creates the flashing coin next to the coin total"""
        self.flashing_coin = flashing_coin.Coin(350, 135)


    def create_mario_image(self):
        """Get the mario image"""
        self.life_times_image = self.get_image(75, 247, 6, 6)
        self.life_times_rect = self.life_times_image.get_rect(center=(600, 525))
        ...
        self.mario_rect = self.mario_image.get_rect(center=(520, 525))
    ...
    def create_time_out_label(self):
        ...
        self.create_label(time_out_label, 'TIME OUT', 490, 430)
    ...
    def create_main_menu_labels(self):
        ...
        self.create_label(player_one_game, '1 PLAYER GAME', 450, 500)
        self.create_label(player_two_game, '2 PLAYER GAME', 450, 570)
        self.create_label(top, 'TOP - ', 450, 640)
        self.create_label(top_score, '000000', 560, 640)
    ...
    def update_count_down_clock(self, level_info):
        ...
        if self.state == c.FAST_COUNT_DOWN:
            ...
            self.time -= 1
        self.count_down_images = []
        self.create_label(self.count_down_images, str(self.time), 950, 135)
        if len(self.count_down_images) < 2:
            for i in range(2):
                self.count_down_images.insert(0, Character(self.image_dict['0']))
            self.set_label_rects(self.count_down_images, 950, 135)
