...
TITLE_IMAGE_SIZE_MULTIPLIER = 2.7
MARIO_SIZE_MULTIPLIER = 2.75
SIZE_MULTIPLIER = 3.75
BRICK_SIZE_MULTIPLIER = 3.75 #砖跟金币的放大比例
# BACKGROUND_MULTIPLER = 2.679
BACKGROUND_MULTIPLER = 1.8 #背景图片放大比例
...
FLAGPOLE = 'flag pole'
CENTER_FLAGPOLE = 'center flag pole'
